...
const AddTodo = () => {
	...
	const handleTaskAdd = (e) => {
		e.preventDefault();
		const message = checkValidation(taskRef.current.value, descRef.current.value);
		...
		<div>
			<form>
				...
				<div className="radioContainer">
					...
					<label>
						<input onChange={handleRadioBtn} type="radio" name="priority" value="Medium"></input>
						Medium
					</label>
					<label>
						<input onChange={handleRadioBtn} type="radio" name="priority" value="Low"></input>
						Low
					</label>
				</div>
